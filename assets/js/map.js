    ...
    if (btnTxt === 'SUBMIT'){
        ...
        if (triesCount === 0){
            if (answer === idx){
                ...
                if (visitedPOIsCount < currentPOIs.features.length -1) {
                    $('#quizQ').html('Great job! You are attentive and your answer is correct!<br> Your next target awaits! Please follow the route to the next point to continue the challenge!');
        ...
        //second submission
            ...
            if (visitedPOIsCount < currentPOIs.features.length -1) {
                ...
                if (answer === idx) {
                    $('#quizQ').html('Much better! Congrats!<br> Your next target awaits! Please follow the route to the next point to continue the challenge!');
                }
                else {
                    $('#quizQ')
